...
\section{Introduction}
 We try to characterize truthful partial implementation in ex post equilibrium with in this Chapter.  Ex post equilibrium 
...
VCG mechanisms and its extensions are successful mechanisms for dominant strategy implementation in private value context. However, for interdependent value framework, VCG are not applicable in general.
...
\begin{proof}
By the necessary and sufficient condition in theorem~\ref{necessary-sufficient}, there must be a $t(\cdot)$ such that
...
The whole argument builds on the assumption of quasilinearity of agents' value function. Under such preference,  money can be utilized 
